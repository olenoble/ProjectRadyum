...
ALL_ROOMS_INFO      db 001b,  0, 2, 0, 0, 0, 0, 0, 0, 0, "Il vous manque une case", "$", (75 - 24) dup (0)
                    db 001b, 17, 3, 19, 8, 0, 1, 0, 0, 0, "Vous devriez utiliser vosdoigts", "$", (75 - 32) dup (0)
                    ...
                    db 001b,  7, 11, 0, 4, 24, 0, 0, 0, 0, "Transcendance", "$", (75 - 14) dup (0)
                    ...
                    db 001b, 13, 14, 2, 2, 0, 7, 8, 0, 0, "Le temps est ecoule", "$", (75 - 20) dup (0)
                    ...
                    db 001b,  8, 12, 0, 5, 27, 0, 0, 0, 0, "Pauvre Blinky", "$", (75 - 14) dup (0)
                    db 001b,  3, 18, 0, 6, 0, 11, 13, 0, 0, "Par ici la sortie", "$", (75 - 18) dup (0)
                    db 001b, 23, 19, 0, 0, 0, 0, 0, 0, 0, "Kori o tokasu", "$", (75 - 14) dup (0)
                    db 001b, 15, 15, 3, 8, 0, 0, 0, 0, 0, "Retour a la racine", "$", (75 - 19) dup (0)
                    db 001b,  0, 16, 0, 16, 0, 9, 16, 14, 0, "A l'identique.           Mais surtout a gauche", "$", (75 - 47) dup (0)
                    db 001b,  9, 17, 0, 22, 6, 15, 0, 15, 0, "Dans la continuite", "$", (75 - 19) dup (0)
                    db 001b,  0, 23, 0, 16, 0, 0, 0, 0, 0, "Un miroir vers l'infini", "$", (75 - 24) dup (0)
                    db 001b,  2, 12, 0, 24, 25, 0, 0, 0, 0, "Remplissez moi jusqu'au  bord", "$", (75 - 30) dup (0)
                    db 001b, 20, 20, 0, 25, 21, 13, 5, 25, 0, "America !", "$", (75 - 10) dup (0)
                    db 001b, 16, 21, 0, 19, 1, 0, 0, 0, 0, "Transcendance", "$", (75 - 14) dup (0)
                    db 001b, 12, 22, 0, 20, 22, 0, 0, 0, 0, "Franchir la ligne", "$", (75 - 18) dup (0)
                    db 001b,  0, 28, 23, 16, 0, 21, 0, 0, 0, "De la Suede a la Norvege", "$", (75 - 25) dup (0)
                    db 001b,  4, 24, 0, 17, 12, 29, 26, 0, 0, "C'est bon les beignets.  Mais je prefererais un   donut", "$", (75 - 56) dup (0)
                    db 001b, 19, 30, 0, 18, 0, 23, 20, 0, 0, "Vive La reine ?", "$", (75 - 16) dup (0)
                    db 001b, 14, 26, 0, 19, 0, 31, 0, 19, 0, "Complementaire", "$", (75 - 15) dup (0)
                    db 111b,  0, 0, 0, 0, 0, 0, 0, 0, 0, "This is the end.         Go towards the light!", "$", (75 - 47) dup (0)
