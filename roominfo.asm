...
ALL_ROOMS_INFO      db 001b,  0, 2, 0, 0, 0, 0, 0, 0, 0, "Il vous manque une case", "$", (75 - 24) dup (0)
                    ...
                    db 001b,  2, 12, 0, 24, 0, 0, 0, 0, 0, "Remplissez moi jusqu'au bord", "$", (75 - 29) dup (0)
                    ...
                    db 001b,  0, 28, 0, 16, 0, 21, 0, 0, 0, "TODO", "$", (75 - 5) dup (0)
                    db 001b,  4, 24, 0, 17, 0, 29, 0, 0, 0, "TODO", "$", (75 - 5) dup (0)
                    db 001b, 19, 30, 0, 18, 0, 23, 0, 0, 0, "Sequence a completer", "$", (75 - 21) dup (0)
                    db 001b, 14, 19, 0, 31, 0, 19, 0, 0, 0, "Complementaire", "$", (75 - 15) dup (0)
                    db 001b,  0, 0, 0, 0, 0, 0, 0, 0, 0, "This is the end", "$", (75 - 16) dup (0)
                    db 001b, 21, 28, 0, 33, 0, 26, 0, 0, 0, "TODO", "$", (75 - 5) dup (0)
                    db 001b, 18, 29, 0, 22, 0, 27, 0, 0, 0, "XOR a droite", "$", (75 - 13) dup (0)
                    db 001b,  1, 30, 0, 35, 0, 23, 0, 28, 0, "Miroir Miroir", "$", (75 - 14) dup (0)
                    db 001b, 22, 24, 0, 29, 0, 0, 0, 0, 0, "4 rotation a droite", "$", (75 - 20) dup (0)
                    db 001b, 24, 32, 0, 25, 0, 0, 0, 0, 0, "TODO", "$", (75 - 5) dup (0)
                    db 001b,  0, 33, 0, 26, 5, 31, 0, 0, 0, "Il vous manque une case", "$", (75 - 24) dup (0)
                    db 001b, 25, 34, 0, 27, 0, 32, 0, 0, 0, "TODO", "$", (75 - 5) dup (0)
                    db 001b,  0, 35, 0, 33, 0, 0, 0, 0, 0, "TODO", "$", (75 - 5) dup (0)
                    db 001b, 27, 36, 0, 29, 0, 34, 0, 0, 0, "TODO", "$", (75 - 5) dup (0)
