...
ROOM_INFO = {1: {'ROOMPASS': 0,
             ...
             2: {'ROOMPASS': ref2num('S32'),  # 17
                 'DOORPASS': {1: ref2num('D11')},
                 'CLUE': 'Vous devriez utiliser vosdoigts',
                 'INFO': {'S': [(1, 'N'), (2, 'W')]},
                 'SOLVER': 'S'
                 },
             3: {'ROOMPASS': ref2num('S11'),  # 10,
                 'DOORPASS': {},
                 'CLUE': 'Un peu de perspective',
                 'SOLVER': 'S'
                 },
             4: {'ROOMPASS': ref2num('D23'),  # 6,
                 'DOORPASS': {},
                 'CLUE': 'Il suffirait de peu pour etre juste',
                 'SOLVER': 'D'
                 },
             5: {'ROOMPASS': ref2num('D31'),  # 7,
                 'DOORPASS': {2: ref2num('G11')},
                 'CLUE': 'Transcendance',
                 'INFO': {'D': [(2, 'S')]},
                 'SOLVER': 'D'
                 },
             ...
             7: {'ROOMPASS': ref2num('S12'),  # 11,
                 'DOORPASS': {},
                 'CLUE': 'Soyons clair et mettons  les points sur les i',
                 'SOLVER': 'S'
                 },
             8: {'ROOMPASS': ref2num('S21'),  # 13,
             ...
             11: {'ROOMPASS': ref2num('D32'),  # 8,
                  'DOORPASS': {2: ref2num('G13')},
                  'CLUE': 'Pauvre Blinky',
                  'INFO': {'D': [(2, 'E')]},
                  'SOLVER': 'D'
                  },
             12: {'ROOMPASS': ref2num('D13'),  # 3,
                  'DOORPASS': {3: ref2num('S32')},
                  'CLUE': 'Par ici la sortie',
                  'INFO': {'D': [(1, 'W'), (3, 'S')]},
                  'SOLVER': 'D'
                  },
             13: {'ROOMPASS': ref2num('G22'),  # 23,
                  'DOORPASS': {},
                  'CLUE': 'Kori o tokasu',
                  'SOLVER': 'G'
                  },
             14: {'ROOMPASS': ref2num('S23'),  # 15,
                  'DOORPASS': {1: ref2num('D31')},
                  'CLUE': 'Retour a la racine',
                  'INFO': {'S': [(1, 'N')]},
                  'SOLVER': 'S'
                  },
             15: {'ROOMPASS': 0,
                  'DOORPASS': {3: ref2num('S33')},
                  'CLUE': 'A l\'identique.           Mais surtout a gauche',
                  'INFO': {'S': [(1, 'N')],
                           'D': [(3, 'E')]}
                  },
             16: {'ROOMPASS': ref2num('D33'),  # 9,
                  'DOORPASS': {2: ref2num('D21'),
                               4: ref2num('G12')},
             ...
             18: {'ROOMPASS': ref2num('D12'),  # 2,
                  'DOORPASS': {},
                  'CLUE': 'Remplissez moi jusqu\'au  bord',
                  'INFO': {'D': [(2, 'W')]},
                  'SOLVER': 'D'
                  },
             19: {'ROOMPASS': ref2num('G12'),  # 20,
             ...
             20: {'ROOMPASS': ref2num('S31'),  # 16,
                  'DOORPASS': {2: ref2num('G22')},
                  'CLUE': 'Transcendance',
                  'INFO': {'S': [(3, 'S'), (2, 'W')]},
                  'SOLVER': 'S'
                  },
             21: {'ROOMPASS': ref2num('S13'),  # 12,
                  'DOORPASS': {2: ref2num('G32')},
                  'CLUE': 'Franchir la ligne',
                  'INFO': {'S': [(2, 'S')]},
                  'SOLVER': 'S'
                  },
             22: {'ROOMPASS': 0,
                  'DOORPASS': {1: ref2num('D23')},
                  'CLUE': 'De la Suede a la Norvege',
                  'INFO': {'S': [(1, 'W'), (3, 'S')]}
                  },
             23: {'ROOMPASS': ref2num('D21'),  # 4,
                  'DOORPASS': {2: ref2num('S13')},
                  'CLUE': 'C\'est bon les beignets. Mais je prefererais un donut',
                  'INFO': {'D': [(2, 'E'), (3, 'W')]},
                  'SOLVER': 'D'
                  },
             24: {'ROOMPASS': ref2num('G11'),  # 19,
                  'DOORPASS': {3: ref2num('G31')},
                  'CLUE': 'Vive La reine ?',
                  'INFO': {'D': [(3, 'S')]},
                  'SOLVER': 'G'
                  },
             25: {'ROOMPASS': ref2num('S22'),  # 14,
                  'DOORPASS': {},
                  'CLUE': 'Complementaire',
                  'INFO': {'S': [(1, 'N')], 'G': [(4, 'E')]},
                  'SOLVER': 'S'
             ...
             27: {'ROOMPASS': ref2num('G13'),  # 21,
                  'DOORPASS': {3: ref2num('S22')},
                  'CLUE': 'Compression horizontale',
                  'INFO': {'G':[(3, 'S')], 'D': [(4, 'S')]},
                  'SOLVER': 'G'
                  },
             28: {'ROOMPASS': ref2num('S33'),  # 18,
                  'CLUE': 'XOR a droite',
                  'INFO': {'D': [(3, 'S')]},
                  'SOLVER': 'S'
                  },
             29: {'ROOMPASS': ref2num('D11'),  # 1,
                  'DOORPASS': {1: ref2num('S23'),
                               4: ref2num('G23')},
                  'CLUE': 'Miroir Miroir',
                  'INFO': {'G': [(1, 'N')],
                           'D': [(4, 'S')]},
             ...
             30: {'ROOMPASS': ref2num('G21'),  # 22,
                  'DOORPASS': {1: ref2num('S31')},
                  'CLUE': '4 rotations a droite',
                  'INFO': {'G': [(1, 'E')]},
                  'SOLVER': 'G'
                  },
             31: {'ROOMPASS': ref2num('G23'),  # 24,
                  'DOORPASS': {2: ref2num('S11')},
                  'CLUE': 'Trop rapide... Reduit le tempo par deux',
                  'INFO': {'G': [(2, 'E')]},
                  'SOLVER': 'G'
                  },
             32: {'ROOMPASS': 0,
                  'DOORPASS': {2: ref2num('D22'),
                               3: ref2num('D12')},
                  'CLUE': 'Il vous manque une case',
                  'INFO': {'G': [(1, 'N'), (2, 'E'), (3, 'S')]}
                  },
             33: {'ROOMPASS': ref2num('G31'),  # 25,
                  'DOORPASS': {1: ref2num('D32'),
                               2: ref2num('S21')},
             ...
             35: {'ROOMPASS': ref2num('G33'),  # 27,
                  'DOORPASS': {1: ref2num('S12')},
                  'CLUE': 'Completez l\'escargot',
                  'INFO': {'G': [(1, 'N'), (2, 'E')]},
                  'SOLVER': 'G'
                  },
             36: {'ROOMPASS': ref2num('G32'),  # 26,
                  'DOORPASS': {},
...
if __name__ == "__main__":
    ...
    print('Overallocated codes --> %s' % ([(i, x) for i, x in enumerate(allpass) if x != 0]))
    print('Overused codes --> %s' % ([(CODE_REFERENCES[i], x) for i, x in enumerate(allrequest) if x != 0]))
